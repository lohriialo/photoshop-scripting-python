...
class _ActionDescriptor(DispatchBaseClass):
	...
	coclass_clsid = IID('{E0B09E62-C974-4CF0-B236-1F82F34F81E1}')
...
class _ActionList(DispatchBaseClass):
	...
	coclass_clsid = IID('{4232D393-E961-4F42-8DE5-99CAE46A3DD3}')
...
class _ActionReference(DispatchBaseClass):
	...
	coclass_clsid = IID('{B24D3780-2629-4EE6-9F9F-6C0A12554B3A}')
...
class _Application(DispatchBaseClass):
	...
	coclass_clsid = IID('{C4C3E2FB-D66C-44E5-96A0-349F951CB3D4}')
...
class _BMPSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{8E67AC07-6214-490B-A4FC-FD884E6FCDBA}')
...
class _BatchOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{890D9FDC-DF16-43F6-8717-A5F3C7055E59}')
...
class _BitmapConversionOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{E159ED38-8580-4119-BB29-97615C72C08B}')
...
class _CMYKColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{D8621099-AF41-4E0F-807A-C7C93825B1EC}')
...
class _CameraRAWOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{7AAEBA41-590E-45B5-82BE-C8439ED48D1A}')
...
class _ContactSheetOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{3B0F2D60-2770-4933-A1F9-A7FF749BD701}')
...
class _DCS1_SaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{0A985EC7-5190-4AC2-9564-8C12B86106A0}')
...
class _DCS2_SaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{243FD2FF-E0A6-4925-B3F9-445E6A0B9CE2}')
...
class _DICOMOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{D9156C17-3E0D-426E-B21C-BB4E3CA8A170}')
...
class _EPSOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{97B95749-BB17-44C0-B79F-4D8D97578C83}')
...
class _EPSSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{FDB3DC93-6FE8-40B9-9922-40D214457F5C}')
...
class _ExportOptionsIllustrator(DispatchBaseClass):
	...
	coclass_clsid = IID('{ADD7C618-7F07-4A45-B1B7-5A253C5577F3}')
...
class _ExportOptionsSaveForWeb(DispatchBaseClass):
	...
	coclass_clsid = IID('{351868F2-EC16-4F60-AE21-8F7A9B0BFD38}')
...
class _GIFSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{08FAD7C2-1393-4572-8764-93908DD5D592}')
...
class _GalleryBannerOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{4273D5A4-6142-47EA-BA50-7D66805528EF}')
...
class _GalleryCustomColorOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{D06CC62C-3B85-4E6D-95F5-3DAA872A7C16}')
...
class _GalleryImagesOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{27BD8440-38D8-4310-9198-9B718CE44FCA}')
...
class _GalleryOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{12C541DD-665A-4C33-AE0C-1838D14FF83C}')
...
class _GallerySecurityOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{DC0839A8-9068-4470-98CB-A1A9DA399053}')
...
class _GalleryThumbnailOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{E2499E27-15F2-4FAA-A219-A2C364B3B0CC}')
...
class _GrayColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{2653E14D-985B-43A0-AFC4-D7295CABA55C}')
...
class _HSBColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{4F20C931-5B67-4EA8-9898-5EC1DE95AD26}')
...
class _IndexedConversionOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{11A0CB09-7997-4902-B4DD-7FCFB260C430}')
...
class _JPEGSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{CFF59FC9-7652-411F-9B2A-83B33C39164F}')
...
class _LabColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{2A98CA9D-5C16-4097-9049-29E2FB27862C}')
...
class _NoColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{5A90DD6C-60F2-4A1E-88EB-45E7841683D1}')
...
class _PDFOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{8C9F92FE-4C6A-4E83-81E1-332BF71ABD79}')
...
class _PDFSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{A0ACC985-A5AF-471D-93F8-8361D759440E}')
...
class _PICTFileSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{BA4E6C6F-F227-42B9-B041-61FA7408B669}')
...
class _PNGSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{3F4AD4F4-6642-4764-AB91-FBBA2743A2B6}')
...
class _PathPointInfo(DispatchBaseClass):
	...
	coclass_clsid = IID('{BC97865E-BA04-4700-A006-2A9A1E2D021E}')
...
class _PhotoCDOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{4096BF2C-7DFF-411E-9D3B-83333337C4CD}')
...
class _PhotoshopSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{0553F558-70DC-4FB4-B084-9193D0F0E46B}')
...
class _PicturePackageOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{822ADB75-BD9B-49D5-BE5B-D5E9B123C36B}')
...
class _PixarSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{4A3A9465-EBF6-417A-AED6-F820726389E1}')
...
class _PresentationOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{4B54536F-EDF4-45EF-900C-8D5516BF3711}')
...
class _RGBColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{31543EF2-5E55-4EC9-8D77-28E2B361B635}')
...
class _RawFormatOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{CA1F9378-D29D-4DB3-A151-BC5BEDA6DAD1}')
...
class _RawSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{988C7E0C-869F-48A8-B96C-CEDF114977B7}')
...
class _SGIRGBSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{BBBBCA2C-DBC4-4198-B51E-93C534AA7A0F}')
...
class _SolidColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{1635F3F2-1D87-41F7-971E-99DE9EFB17AE}')
...
class _SubPathInfo(DispatchBaseClass):
	...
	coclass_clsid = IID('{B65274C2-B16C-4FD1-B570-3BACDEE10DE3}')
...
class _TargaSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{5F8F79CF-3F58-4663-8F7D-EFC3240F7E19}')
...
class _TiffSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{0C51EB93-E408-42C2-BA68-4E15D292ADE1}')
...
# This CoClass is known by the name 'Photoshop.ActionDescriptor.140'
class ActionDescriptor(CoClassBaseClass): # A CoClass
	CLSID = IID('{E0B09E62-C974-4CF0-B236-1F82F34F81E1}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ActionDescriptor,
...
# This CoClass is known by the name 'Photoshop.ActionList.140'
class ActionList(CoClassBaseClass): # A CoClass
	CLSID = IID('{4232D393-E961-4F42-8DE5-99CAE46A3DD3}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ActionList,
...
# This CoClass is known by the name 'Photoshop.ActionReference.140'
class ActionReference(CoClassBaseClass): # A CoClass
	CLSID = IID('{B24D3780-2629-4EE6-9F9F-6C0A12554B3A}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ActionReference,
...
# This CoClass is known by the name 'Photoshop.Application.140'
class Application(CoClassBaseClass): # A CoClass
	# The Adobe Photoshop application
	CLSID = IID('{C4C3E2FB-D66C-44E5-96A0-349F951CB3D4}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_Application,
...
# This CoClass is known by the name 'Photoshop.BMPSaveOptions.140'
class BMPSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a BMP document
	CLSID = IID('{8E67AC07-6214-490B-A4FC-FD884E6FCDBA}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_BMPSaveOptions,
...
# This CoClass is known by the name 'Photoshop.BatchOptions.140'
class BatchOptions(CoClassBaseClass): # A CoClass
	# options for the Batch command
	CLSID = IID('{890D9FDC-DF16-43F6-8717-A5F3C7055E59}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_BatchOptions,
...
# This CoClass is known by the name 'Photoshop.BitmapConversionOptions.140'
class BitmapConversionOptions(CoClassBaseClass): # A CoClass
	# Settings related to changing the document mode to Bitmap
	CLSID = IID('{E159ED38-8580-4119-BB29-97615C72C08B}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.CMYKColor.140'
class CMYKColor(CoClassBaseClass): # A CoClass
	# A CMYK color specification
	CLSID = IID('{D8621099-AF41-4E0F-807A-C7C93825B1EC}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_CMYKColor,
...
# This CoClass is known by the name 'Photoshop.CameraRAWOpenOptions.140'
class CameraRAWOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a camera RAW document
	CLSID = IID('{7AAEBA41-590E-45B5-82BE-C8439ED48D1A}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.ContactSheetOptions.140'
class ContactSheetOptions(CoClassBaseClass): # A CoClass
	# Options for the Contact Sheet command
	CLSID = IID('{3B0F2D60-2770-4933-A1F9-A7FF749BD701}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.DCS1_SaveOptions.140'
class DCS1_SaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Photoshop DCS 1.0 document
	CLSID = IID('{0A985EC7-5190-4AC2-9564-8C12B86106A0}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_DCS1_SaveOptions,
...
# This CoClass is known by the name 'Photoshop.DCS2_SaveOptions.140'
class DCS2_SaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Photoshop DCS 2.0 document
	CLSID = IID('{243FD2FF-E0A6-4925-B3F9-445E6A0B9CE2}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_DCS2_SaveOptions,
...
# This CoClass is known by the name 'Photoshop.DICOMOpenOptions.140'
class DICOMOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a DICOM document
	CLSID = IID('{D9156C17-3E0D-426E-B21C-BB4E3CA8A170}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_DICOMOpenOptions,
...
# This CoClass is known by the name 'Photoshop.EPSOpenOptions.140'
class EPSOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a generic EPS document
	CLSID = IID('{97B95749-BB17-44C0-B79F-4D8D97578C83}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_EPSOpenOptions,
...
# This CoClass is known by the name 'Photoshop.EPSSaveOptions.140'
class EPSSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving an EPS document
	CLSID = IID('{FDB3DC93-6FE8-40B9-9922-40D214457F5C}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_EPSSaveOptions,
...
# This CoClass is known by the name 'Photoshop.ExportOptionsIllustrator.140'
class ExportOptionsIllustrator(CoClassBaseClass): # A CoClass
	# Settings related to exporting Illustrator paths
	CLSID = IID('{ADD7C618-7F07-4A45-B1B7-5A253C5577F3}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.ExportOptionsSaveForWeb.140'
class ExportOptionsSaveForWeb(CoClassBaseClass): # A CoClass
	# Settings related to exporting Save For Web files
	CLSID = IID('{351868F2-EC16-4F60-AE21-8F7A9B0BFD38}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GIFSaveOptions.140'
class GIFSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a GIF document
	CLSID = IID('{08FAD7C2-1393-4572-8764-93908DD5D592}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_GIFSaveOptions,
...
# This CoClass is known by the name 'Photoshop.GalleryBannerOptions.140'
class GalleryBannerOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery banner options
	CLSID = IID('{4273D5A4-6142-47EA-BA50-7D66805528EF}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GalleryCustomColorOptions.140'
class GalleryCustomColorOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery colors
	CLSID = IID('{D06CC62C-3B85-4E6D-95F5-3DAA872A7C16}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GalleryImagesOptions.140'
class GalleryImagesOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery images
	CLSID = IID('{27BD8440-38D8-4310-9198-9B718CE44FCA}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GalleryOptions.140'
class GalleryOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery command
	CLSID = IID('{12C541DD-665A-4C33-AE0C-1838D14FF83C}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_GalleryOptions,
...
# This CoClass is known by the name 'Photoshop.GallerySecurityOptions.140'
class GallerySecurityOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery security
	CLSID = IID('{DC0839A8-9068-4470-98CB-A1A9DA399053}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GalleryThumbnailOptions.140'
class GalleryThumbnailOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery thumbnail creation
	CLSID = IID('{E2499E27-15F2-4FAA-A219-A2C364B3B0CC}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GrayColor.140'
class GrayColor(CoClassBaseClass): # A CoClass
	# A gray color specification
	CLSID = IID('{2653E14D-985B-43A0-AFC4-D7295CABA55C}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_GrayColor,
...
# This CoClass is known by the name 'Photoshop.HSBColor.140'
class HSBColor(CoClassBaseClass): # A CoClass
	# An HSB color specification
	CLSID = IID('{4F20C931-5B67-4EA8-9898-5EC1DE95AD26}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_HSBColor,
...
# This CoClass is known by the name 'Photoshop.IndexedConversionOptions.140'
class IndexedConversionOptions(CoClassBaseClass): # A CoClass
	# Settings related to changing the document mode to Indexed
	CLSID = IID('{11A0CB09-7997-4902-B4DD-7FCFB260C430}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.JPEGSaveOptions.140'
class JPEGSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a JPEG document
	CLSID = IID('{CFF59FC9-7652-411F-9B2A-83B33C39164F}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_JPEGSaveOptions,
...
# This CoClass is known by the name 'Photoshop.LabColor.140'
class LabColor(CoClassBaseClass): # A CoClass
	# An Lab color specification
	CLSID = IID('{2A98CA9D-5C16-4097-9049-29E2FB27862C}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_LabColor,
...
# This CoClass is known by the name 'Photoshop.NoColor.140'
class NoColor(CoClassBaseClass): # A CoClass
	# represents a missing color
	CLSID = IID('{5A90DD6C-60F2-4A1E-88EB-45E7841683D1}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_NoColor,
...
# This CoClass is known by the name 'Photoshop.PDFOpenOptions.140'
class PDFOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a generic PDF document
	CLSID = IID('{8C9F92FE-4C6A-4E83-81E1-332BF71ABD79}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PDFOpenOptions,
...
# This CoClass is known by the name 'Photoshop.PDFSaveOptions.140'
class PDFSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a pdf document
	CLSID = IID('{A0ACC985-A5AF-471D-93F8-8361D759440E}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PDFSaveOptions,
...
# This CoClass is known by the name 'Photoshop.PICTFileSaveOptions.140'
class PICTFileSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a PICT document
	CLSID = IID('{BA4E6C6F-F227-42B9-B041-61FA7408B669}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.PNGSaveOptions.140'
class PNGSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a PNG document
	CLSID = IID('{3F4AD4F4-6642-4764-AB91-FBBA2743A2B6}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PNGSaveOptions,
...
# This CoClass is known by the name 'Photoshop.PathPointInfo.140'
class PathPointInfo(CoClassBaseClass): # A CoClass
	# Path point information (returned by entire path dataClassProperty of path item class)
	CLSID = IID('{BC97865E-BA04-4700-A006-2A9A1E2D021E}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PathPointInfo,
...
# This CoClass is known by the name 'Photoshop.PhotoCDOpenOptions.140'
class PhotoCDOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a PhotoCD document
	CLSID = IID('{4096BF2C-7DFF-411E-9D3B-83333337C4CD}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PhotoCDOpenOptions,
...
# This CoClass is known by the name 'Photoshop.PhotoshopSaveOptions.140'
class PhotoshopSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Photoshop document
	CLSID = IID('{0553F558-70DC-4FB4-B084-9193D0F0E46B}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.PicturePackageOptions.140'
class PicturePackageOptions(CoClassBaseClass): # A CoClass
	# options for the Picture Package command
	CLSID = IID('{822ADB75-BD9B-49D5-BE5B-D5E9B123C36B}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.PixarSaveOptions.140'
class PixarSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Pixar document
	CLSID = IID('{4A3A9465-EBF6-417A-AED6-F820726389E1}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PixarSaveOptions,
...
# This CoClass is known by the name 'Photoshop.PresentationOptions.140'
class PresentationOptions(CoClassBaseClass): # A CoClass
	# options for the PDF presentation command
	CLSID = IID('{4B54536F-EDF4-45EF-900C-8D5516BF3711}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.RGBColor.140'
class RGBColor(CoClassBaseClass): # A CoClass
	# An RGB color specification
	CLSID = IID('{31543EF2-5E55-4EC9-8D77-28E2B361B635}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_RGBColor,
...
# This CoClass is known by the name 'Photoshop.RawFormatOpenOptions.140'
class RawFormatOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a raw format document
	CLSID = IID('{CA1F9378-D29D-4DB3-A151-BC5BEDA6DAD1}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.RawSaveOptions.140'
class RawSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a document in raw format
	CLSID = IID('{988C7E0C-869F-48A8-B96C-CEDF114977B7}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_RawSaveOptions,
...
# This CoClass is known by the name 'Photoshop.SGIRGBSaveOptions.140'
class SGIRGBSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a document in the SGI RGB format
	CLSID = IID('{BBBBCA2C-DBC4-4198-B51E-93C534AA7A0F}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_SGIRGBSaveOptions,
...
# This CoClass is known by the name 'Photoshop.SolidColor.140'
class SolidColor(CoClassBaseClass): # A CoClass
	# A color value
	CLSID = IID('{1635F3F2-1D87-41F7-971E-99DE9EFB17AE}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_SolidColor,
...
# This CoClass is known by the name 'Photoshop.SubPathInfo.140'
class SubPathInfo(CoClassBaseClass): # A CoClass
	# Sub path information (returned by entire path dataClassProperty of path item class)
	CLSID = IID('{B65274C2-B16C-4FD1-B570-3BACDEE10DE3}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_SubPathInfo,
...
# This CoClass is known by the name 'Photoshop.TargaSaveOptions.140'
class TargaSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Target document
	CLSID = IID('{5F8F79CF-3F58-4663-8F7D-EFC3240F7E19}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_TargaSaveOptions,
...
# This CoClass is known by the name 'Photoshop.TiffSaveOptions.140'
class TiffSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a TIFF document
	CLSID = IID('{0C51EB93-E408-42C2-BA68-4E15D292ADE1}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_TiffSaveOptions,
...
CLSIDToClassMap = {
	'{3F4AD4F4-6642-4764-AB91-FBBA2743A2B6}' : PNGSaveOptions,
	'{ADD7C618-7F07-4A45-B1B7-5A253C5577F3}' : ExportOptionsIllustrator,
	'{8E67AC07-6214-490B-A4FC-FD884E6FCDBA}' : BMPSaveOptions,
	'{7D14BA29-1672-482F-8F48-9DA1E94800FD}' : PathPoint,
	'{1635F3F2-1D87-41F7-971E-99DE9EFB17AE}' : SolidColor,
	...
	'{FDB3DC93-6FE8-40B9-9922-40D214457F5C}' : EPSSaveOptions,
	...
	'{27BD8440-38D8-4310-9198-9B718CE44FCA}' : GalleryImagesOptions,
	'{4B54536F-EDF4-45EF-900C-8D5516BF3711}' : PresentationOptions,
	'{632F36B3-1D76-48BE-ADC3-D7FB62A0C2FB}' : MeasurementScale,
	'{F4E21694-AEBF-44FB-90AB-EECD58C1B6F3}' : _TargaSaveOptions,
	'{2A98CA9D-5C16-4097-9049-29E2FB27862C}' : LabColor,
	'{890D9FDC-DF16-43F6-8717-A5F3C7055E59}' : BatchOptions,
	'{12C541DD-665A-4C33-AE0C-1838D14FF83C}' : GalleryOptions,
	'{351868F2-EC16-4F60-AE21-8F7A9B0BFD38}' : ExportOptionsSaveForWeb,
	'{8B0CB532-4ACC-4BF3-9E42-0949B679D120}' : PathItem,
	'{861C9290-2A0C-4614-8606-706B31BFD45B}' : Notifiers,
	'{B24D3780-2629-4EE6-9F9F-6C0A12554B3A}' : ActionReference,
	'{84ADBF06-8354-4B5C-9CB1-EA2565B66C7C}' : MeasurementLog,
	'{5A90DD6C-60F2-4A1E-88EB-45E7841683D1}' : NoColor,
	'{7AAEBA41-590E-45B5-82BE-C8439ED48D1A}' : CameraRAWOpenOptions,
	'{746FEF90-A182-4BD0-A4F6-BB6BBAE87A78}' : DocumentInfo,
	'{988C7E0C-869F-48A8-B96C-CEDF114977B7}' : RawSaveOptions,
	'{DC865034-A587-4CC4-8A5A-453032562BE4}' : XMPMetadata,
	'{EE8364D9-B811-4C7D-A3A8-97C4EBFAB83A}' : _DICOMOpenOptions,
	'{4A3A9465-EBF6-417A-AED6-F820726389E1}' : PixarSaveOptions,
	'{822ADB75-BD9B-49D5-BE5B-D5E9B123C36B}' : PicturePackageOptions,
	'{EC6A366C-F901-488D-A2C3-9E2E78B72DC6}' : ArtLayers,
	'{643099A1-0B67-4920-9B14-E14BE8F63D5F}' : _BitmapConversionOptions,
	'{243FD2FF-E0A6-4925-B3F9-445E6A0B9CE2}' : DCS2_SaveOptions,
	'{C4C3E2FB-D66C-44E5-96A0-349F951CB3D4}' : Application,
	...
	'{CA1F9378-D29D-4DB3-A151-BC5BEDA6DAD1}' : RawFormatOpenOptions,
	'{0A985EC7-5190-4AC2-9564-8C12B86106A0}' : DCS1_SaveOptions,
	...
	'{11A0CB09-7997-4902-B4DD-7FCFB260C430}' : IndexedConversionOptions,
	'{F715C957-54CE-4E55-9856-591D4CD082FD}' : _EPSOpenOptions,
	'{D2D1665E-C1B9-4CA0-8AC9-529F6A3D9002}' : _SolidColor,
	'{4F20C931-5B67-4EA8-9898-5EC1DE95AD26}' : HSBColor,
	'{D9156C17-3E0D-426E-B21C-BB4E3CA8A170}' : DICOMOpenOptions,
	...
	'{E2499E27-15F2-4FAA-A219-A2C364B3B0CC}' : GalleryThumbnailOptions,
	'{4273D5A4-6142-47EA-BA50-7D66805528EF}' : GalleryBannerOptions,
	'{16BE80A3-57B1-4871-83AC-7F844EEEB1CA}' : ArtLayer,
	'{0C51EB93-E408-42C2-BA68-4E15D292ADE1}' : TiffSaveOptions,
	'{45F1195F-3554-4B3F-A00A-E1D189C0DC3E}' : _RGBColor,
	'{31543EF2-5E55-4EC9-8D77-28E2B361B635}' : RGBColor,
	...
	'{4232D393-E961-4F42-8DE5-99CAE46A3DD3}' : ActionList,
	'{BC97865E-BA04-4700-A006-2A9A1E2D021E}' : PathPointInfo,
	'{08FAD7C2-1393-4572-8764-93908DD5D592}' : GIFSaveOptions,
	'{09DA6B10-9684-44EE-A575-01F54660BDDC}' : Selection,
	'{5F168D2A-F9EA-4866-8C55-4875E0940622}' : _GalleryBannerOptions,
	'{DC0839A8-9068-4470-98CB-A1A9DA399053}' : GallerySecurityOptions,
	...
	'{5F8F79CF-3F58-4663-8F7D-EFC3240F7E19}' : TargaSaveOptions,
	...
	'{8C9F92FE-4C6A-4E83-81E1-332BF71ABD79}' : PDFOpenOptions,
	'{B125A66B-4C94-4E55-AF2F-57EC4DCB484B}' : ColorSampler,
	'{3B0F2D60-2770-4933-A1F9-A7FF749BD701}' : ContactSheetOptions,
	'{478BF855-E42A-4D63-8C9D-F562DE5FF7A8}' : _PNGSaveOptions,
	'{CFF59FC9-7652-411F-9B2A-83B33C39164F}' : JPEGSaveOptions,
	...
	'{4096BF2C-7DFF-411E-9D3B-83333337C4CD}' : PhotoCDOpenOptions,
